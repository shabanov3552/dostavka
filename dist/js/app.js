    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            ...
                            if (spollerTitle.closest(".case-card")) spollerTitle.closest(".case-card").classList.toggle("_spoller-active");
                ...
                function hideSpollersBody(spollersBlock) {
                    ...
                    if (spollerActiveTitle && !spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        if (spollerActiveTitle.closest(".case-card")) spollerActiveTitle.closest(".case-card").classList.remove("_spoller-active");
                ...
                if (spollersClose.length) document.addEventListener("click", (function(e) {
                    ...
                    if (!el.closest("[data-spollers]")) spollersClose.forEach((spollerClose => {
                        ...
                        if (spollersBlock.classList.contains("_spoller-init")) {
                            ...
                            if (spollerClose.closest(".case-card")) spollerClose.closest(".case-card").classList.remove("_spoller-active");
        ...
        class Popup {
            ...
            _openToHash() {
                ...
                if (buttons !== null) this.youTubeCode = buttons.getAttribute(this.options.youtubeAttribute) ? buttons.getAttribute(this.options.youtubeAttribute) : null;
        ...
        function initSliders() {
            ...
            if (document.querySelector(".news-feed__slider")) new swiper_core_Swiper(".news-feed__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".services-feed__slider")) new swiper_core_Swiper(".services-feed__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".mp-clients__slider")) new swiper_core_Swiper(".mp-clients__slider", {
            ...
            if (document.querySelector(".news-detail__slider")) new swiper_core_Swiper(".news-detail__slider", {
